...
export default function ModalScreen() {
  return (
    <View style={styles.container}>
      ...
      <Text> Borrow only what you need now, for what you want.
        {"\n"}{"\n"}
      ...
      {"\n"}{"\n"}
      A TD Personal Loan is a flexible borrowing solution that you can use to borrow money for a specific goal.
      You can use a loan to finance a renovation project, make a big purchase or consolidate your higher interest debts. Loans are available with fixed or variable interest rates and come with flexible repayment options to help you budget.
      Call, click, or visit a TD Branch to apply for a personal loan.
      {"\n"}{"\n"}{"\n"}{"\n"} </Text>

  <Text style={styles.subtitle}>Small Business Loans </Text>
  <Text>
  A Small Business Loan can help you purchase business assets or finance expansion plans.
  {"\n"}{"\n"}{"\n"}
Fixed or floating interest rates are available for Small Business Loans.
{"\n"}{"\n"}
Flexible security options include: business assets, business real estate, residential real estate (full or partial), liquid or margin security (full or partial)
{"\n"}{"\n"}
